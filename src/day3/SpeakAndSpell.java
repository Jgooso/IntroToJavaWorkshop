...
speak("spell pneumonoultramiscroscopicsilicovolcanoconiosis");
		// 2. Catch the user's answer in a String
String ans= JOptionPane.showInputDialog();
		// 3. If the user spelled the word correctly, speak "correct"
if(ans.equals("pneumonoultramicroscopicsilicovolcanoconiosios")){
	speak("You are a nerd");
}
		// 4. Otherwise say "wrong"
else{
	speak("Good Job, you are not a nerd");
}
