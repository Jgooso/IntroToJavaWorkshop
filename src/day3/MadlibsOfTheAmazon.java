...
String adjective = JOptionPane.showInputDialog("Enter a comparative adjective.");
...
String place = JOptionPane.showInputDialog("Enter a place.");
	...
	JOptionPane.showMessageDialog(null, "Piranhas are "+ adjective + " during the day, so cross the river at \nnight. Piranhas are atracted to fresh " + liquid +" and will most \nlikely  take a bite out of your " + bodypart + " if you "+ verb +".Whatever \nyou do, if you have an open wound, try to find another way to get \nback to the "+ place + ". Good luck! ");
